...
std::map<std::string, std::unique_ptr<SoundSource>> SoundManager::Data;

// 音源
SoundSource::SoundSource(IDirectSound* ds, const char* filename)
{
	HRESULT hr = S_OK;
...
{
	soundManager = std::make_unique<SoundManager>(GetSystemManager->hwnd);
	Load();
}
...
{
	Data["BGM"] = GetInstance()->soundManager->CreateSoundSource("Data/Sounds/BGM.wav");
	Data["Coin"] = GetInstance()->soundManager->CreateSoundSource("Data/Sounds/Coin.wav");
	Data["Decision"] = GetInstance()->soundManager->CreateSoundSource("Data/Sounds/Decision.wav");
	Data["Jump"] = GetInstance()->soundManager->CreateSoundSource("Data/Sounds/Jump.wav");
	Data["Move"] = GetInstance()->soundManager->CreateSoundSource("Data/Sounds/Move.wav");
	Data["Score"] = GetInstance()->soundManager->CreateSoundSource("Data/Sounds/Score.wav");
	Data["Stage"] = GetInstance()->soundManager->CreateSoundSource("Data/Sounds/Stage.wav");
	Data["SpeedUp"] = GetInstance()->soundManager->CreateSoundSource("Data/Sounds/SpeedUp.wav");
}
